  ...
  return (
    <div className="w-full max-h-screen px-10 mx-auto">
      <div className="text-center mx-auto flex flex-col justify-center h-full">
        <div className="max-w-[600px] w-full items-center grid grid-cols-1 gap-8 mx-auto">
          <h1 className="mt-20 text-3xl text-[#C8A951]"> ABOUT </h1>
          <p className="font-extralight mx-auto text-gray-500">
          ...
          <p className="font-extralight mb-20 mx-auto text-gray-500">
            {" "}
