...
export default function Projects() {
  return (
    <div className="w-full max-h-screen px-2">
      <h1 className="mt-24 text-center text-3xl md:text-4xl 2xl:text-6xl font-light text-[#C8A951] mx-auto justify-center">
        PROJECTS
      </h1>

      <div className="flex flex-col gap-4 mt-6 pb-20 lg:flex-row">
        <div className="basis-1/3 items-center flex-auto text-center rounded-lg pt-4 pb-8 px-4 my-6 mx-12 shadow-md shadow-[#040c16] hover:scale-110 duration-500">
          ...
          >
            <h3 className="text-xl 2xl:text-2xl font-extralight mb-2 py-2">
              {" "}
              CRYPTOCADEMY{" "}
            </h3>
            <div className=" relative overflow-hidden">
              ...
              <div className="absolute px-2 pb-2 h-full w-full bg-black/80 text-white flex flex-col items-center justify-center bottom-0 group:bottom-0 opacity-0 hover:opacity-100 transition-all duration-300">
                <p className="text-xs 2xl:text:md font-light px-2 pb-2">
                  {" "}
                  Served as a full stack Ruby on Rails developer in a team of 4.
                  Creating and deploying this educational blockchain app in
                  under 2 weeks.
                </p>
                <p className="text-xs 2xl:text:md font-light pt-4">
                  {" "}
                  Ruby on Rails | JavaScript | PostgreSQL | SASS | Heroku{" "}
                </p>
              </div>
            </div>
            <p className="text-xs 2xl:text-md pt-4 font-extralight text-gray-600 underline decoration-gray-600 underline-offset-4 hover:text-[#C8A951] hover:decoration-[#C8A951]">
          ...
          >
            ...
            <div className="relative overflow-hidden">
              ...
              <div className="absolute p-4 h-full w-full bg-black/80 text-white flex flex-col items-center justify-center bottom-0 opacity-0 hover:opacity-100 transition-all duration-300">
                <p className="text-xs 2xl:text:md font-light p-2">
        ...
        <div className="basis-1/3 items-center flex-auto text-center rounded-lg pt-4 pb-8 px-4 mt-6 mb-6 mx-12 shadow-md shadow-[#040c16] hover:scale-110 duration-500">
          <a
            ...
            className="text-gray-600 text-lg hover:text-[#C8A951]"
          >
            <h3 className="text-xl font-extralight mb-2 py-2 2xl:text-2xl">
              MEME MARKET
            </h3>
            <div className="relative overflow-hidden">
              ...
              <div className="absolute py-10 px-4 h-full w-full bg-black/80 text-white flex flex-col items-center justify-center bottom-0 group-hover:bottom-0 opacity-0 hover:opacity-100 transition-all duration-300">
                <p className="text-xs 2xl:text:md font-light pt-2 px-2">
                ...
                <p className="text-xs 2xl:text:md font-light pt-4 pb-2">
                  {" "}
                  Ruby on Rails | JavaScript | PostgreSQL | SASS | Heroku{" "}
                </p>
              </div>
            </div>
            <p className="text-xs pt-6 font-extralight 2xl:text-md text-gray-600 underline decoration-gray-600 underline-offset-4 hover:text-[#C8A951] hover:decoration-[#C8A951]">
