  ...
  return (
    <div className="fixed left-0 top-0 w-full z-10 px-10 ease-in duration-300 bg-[#191b1d]">
      <div className="max-w-[1240px] h-[50px] m-auto flex justify-between items-center p-4 text-black">
        <Link href="/">
          <a className="font-poppins font-extralight text-[#C8A951] hover:underline hover:decoration-[#C8A951] underline-offset-4">
            RYLAN MCNEIL
          </a>
        </Link>
        <ul className="hidden text-white text-xs font-poppins font-thin sm:space-x-6 sm:flex">
          <li className=" hover:underline hover:decoration-[#C8A951] underline-offset-4">
